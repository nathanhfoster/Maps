...
import { DEFAULT_STROKE, SELECTED_COLOR, NOT_ATTACHED_OR_SELECTED_COLOR } from '../PolygonSystem'
...
const DrawingManager = props => {
  ...
  const handleMouseMove = () => {
    ...
    const shouldCompletePolygon =
      handleShouldCompletePolygon(mousePos, newPolygon) && !drawnPolylineIsIntersecting
