      ...
      <Container className="PrivacyPolicy Container">
        <Row>
          <Col xs={12}>
            ...
            <p>
              Radius ("us", "we", or "our") operates the https://Radius.com/
              website (the "Service").
            </p>
            ...
            <p>Radius uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
              Radius will take all steps reasonably necessary to ensure that
            ...
            <p>
              Radius may disclose your Personal Data in the good faith belief
              that such action is necessary to:
            </p>
            <ul>
              <li>To comply with a legal obligation</li>
              <li>To protect and defend the rights or property of Radius</li>
              <li>
            ...
            <ul>
              <li>By visiting this page on our website: https://Radius.com/</li>
            </ul>
          </Col>
        </Row>
      </Container>
